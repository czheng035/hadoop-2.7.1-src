...
public class ApplicationReportPBImpl extends ApplicationReport {
  ...
  private Resource pendingResources;
  ...
  public Resource getPendingResources() {
    ...
    ApplicationReportProtoOrBuilder p = viaProto ? proto : builder;
    if (!p.hasPendingResources()) {
      return null;
    }
    this.pendingResources = convertFromProtoFormat(p.getPendingResources());
    return this.pendingResources;
  }
  ...
  @Override
  public void setPendingResources(Resource pendingRequests) {
    maybeInitBuilder();
    if (pendingRequests == null)
      builder.clearPendingResources();
    this.pendingResources = pendingRequests;
  }
  ...
  private void mergeLocalToBuilder() {
    ...
    if (this.pendingResources != null
        && !((ResourcePBImpl) this.pendingResources).getProto().equals(
            builder.getPendingResources())) {
      builder.setPendingResources(convertToProtoFormat(this.pendingResources));
    }
  }
  ...
  private ResourcePBImpl convertFromProtoFormat(ResourceProto pendingResources) {
    return new ResourcePBImpl(pendingResources);
  }
}
